...
Querying: When you ask a question, the app finds the most relevant chunks in the FAISS vector store and passes them to the Llama 3 model to generate an answer.
